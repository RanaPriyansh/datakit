...
Repository: https://github.com/RanaPriyansh/datakit.git
Canonical local path: /root/datakit
Default branch: main
...
3. Run the local setup path for datakit and write exact commands back into README if they are missing or stale.
